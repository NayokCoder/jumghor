...
export default function Banner() {
  ...
  return (
    <div ref={sliderRef} className="keen-slider relative w-[95%] max-w-full min-h-[50vh] md:min-h-[60vh] lg:min-h-[70vh]  xl:min-h-[80vh] mx-auto overflow-hidden rounded-sm shadow-lg">
